...
class BuilderProcessor(
    ...
    private fun generateCode(annotations: List<Unit>) {
        thread {
            val tablePackage = "com.arch.jonnyhsia.compass"
            val tableName = "CompassTable"
            codeGenerator.createNewFile(
                ...
                FileSpec.builder(tablePackage, tableName)
                    .addType(
                        TypeSpec.classBuilder(tableName)
                            .primaryConstructor(
